...
namespace CleanArchitecture.Infraestructure.Migrations
{
    ...
    [Migration("20250506041314_OutboxCreationMigrations")]
    partial class OutboxCreationMigrations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Reviews.Review", b =>
                {
                    ...
                    b.Property<Guid?>("AlguilerId")
                        .HasColumnType("uuid")
                        .HasColumnName("alguiler_id");
                    ...
                    b.HasIndex("AlguilerId")
                        .HasDatabaseName("ix_reviews_alguiler_id");
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Alquileres.Alquiler", b =>
                {
                    ...
                    b.OwnsOne("CleanArchitecture.Domain.Shared.Moneda", "PrecioPorPediodo", b1 =>
                        {
                            b1.Property<Guid>("AlquilerId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<decimal>("Monto")
                                .HasColumnType("numeric")
                                .HasColumnName("precio_por_pediodo_monto");

                            b1.Property<string>("TipoMoneda")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("precio_por_pediodo_tipo_moneda");
                    ...
                    b.OwnsOne("CleanArchitecture.Domain.Vehiculos.Direccion", "Direccion", b1 =>
                        {
                            ...
                            b1.Property<string>("Colonia")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("direccion_colonia");
